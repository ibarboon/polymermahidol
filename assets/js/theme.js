	...
	$.extend(theme, {
		...
		Account: {
			...
			initialize: function($wrapper, opts) {
				...
				initialized = true;
				this.$wrapper = ($wrapper || this.defaultOptions.wrapper);
			...
			setOptions: function(opts) {
				this.options = $.extend(true, {}, this.defaultOptions, opts, this.$wrapper.data('plugin-options'));
			...
			events: function() {
				...
				$('#headerSignUp').on('click', function(e) {
					e.preventDefault();
					self.addClass('signup').removeClass('signin').removeClass('recover');
					self.find('.signup-form input:first').focus();
				});

				$('#headerSignIn').on('click', function(e) {
					e.preventDefault();
					self.addClass('signin').removeClass('signup').removeClass('recover');
					self.find('.signin-form input:first').focus();
				});

				$('#headerRecover').on('click', function(e) {
					e.preventDefault();
					self.addClass('recover').removeClass('signup').removeClass('signin');
					self.find('.recover-form input:first').focus();
				});
