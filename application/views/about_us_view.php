				...
				<div class="nivo-slider">
					<div class="slider-wrapper theme-default">
						<div id="nivoSlider" class="nivoSlider">
							<img src="<?php echo base_url('assets/img/slides/tmp-slide-1.jpg'); ?>" data-thumb="<?php echo base_url('assets/img/slides/tmp-slide-1.jpg'); ?>" alt="" />
							<img src="<?php echo base_url('assets/img/slides/tmp-slide-2.jpg'); ?>" data-thumb="<?php echo base_url('assets/img/slides/tmp-slide-2.jpg'); ?>" alt="" />
							<img src="<?php echo base_url('assets/img/slides/tmp-slide-3.jpg'); ?>" data-thumb="<?php echo base_url('assets/img/slides/tmp-slide-1.jpg'); ?>" alt="" />
							<img src="<?php echo base_url('assets/img/slides/tmp-slide-4.jpg'); ?>" data-thumb="<?php echo base_url('assets/img/slides/tmp-slide-2.jpg'); ?>" alt="" />
						</div>
				...
				<div class="col-md-4 col-md-offset-1">
					<div class="project-image">
						<div id="fcSlideshow" class="fc-slideshow">
							<ul class="fc-slides">
								<li><a href="#"><img class="img-responsive" src="<?php echo base_url('assets/img/projects/project-home-1.jpg'); ?>" /></a></li>
								<li><a href="#"><img class="img-responsive" src="<?php echo base_url('assets/img/projects/project-home-2.jpg'); ?>" /></a></li>
								<li><a href="#"><img class="img-responsive" src="<?php echo base_url('assets/img/projects/project-home-3.jpg'); ?>" /></a></li>
							</ul>
						</div>
	...
	<div class="container">
		...
		<div class="row center">
			<div class="owl-carousel" data-plugin-options='{"items": 6, "singleItem": false, "autoPlay": true}'>
				...
				<div>
					<img class="img-responsive" src="<?php echo base_url('assets/img/logos/logo-7.png'); ?>" alt="">
				</div>
				<div>
					<img class="img-responsive" src="<?php echo base_url('assets/img/logos/logo-8.png'); ?>" alt="">
				</div>
			</div>
		</div>
	</div>
