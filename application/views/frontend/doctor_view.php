						...
						<div class="row">
							<div class="col-md-12">
								<ul class="breadcrumb">
									...
									<li class="active">Doctor of Philosophy Program in Polymer Science and Technology (International Program)</li>
								</ul>
							</div>
						</div>
						<div class="row">
							<div class="col-md-12">
								<h2>Doctor of Philosophy Program in Polymer Science and Technology (International Program)</h2>
							</div>
						</div>
					</div>
				</section>
				<div class="container">
					<div class="row">
						<div class="col-md-12">
							<table class="table table-bordered">
								<thead>
									<tr>
										<th colspan="4">Curriculum Structure</th>
									</tr>
								</thead>
								<tbody>
									<tr>
										<td colspan="2">For students with Bachelor’s degree</td>
										<td colspan="2">For students with Master’s degree</td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td><strong>72 credits</strong></td>
										<td><strong>Total not less than</strong></td>
					...
					<div class="row">
						<div class="col-md-12">
							...
							<h4>Thesis</h4>
							<p><strong>For students with Bachelor’s degree 48 credits<br>For students with Master’s degree  36 credits</strong></p>
							<dl>
								<dt>SCCH 699 : Dissertation (36/48 credits)</dt>
								<dd>Identifying research proposal. Conducting research with concern of research ethics. Data collection, analysis, interpretation of the result and report the result in terms of thesis. Presenting and Publishing research in international peer-reviewed journal.</dd>
							</dl>
						</div>
					</div>
				</div>
